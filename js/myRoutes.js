...
var distance_between_coordinates = 0.5; //The smaller the distance, the greater the presicion but the longer the waiting time
var margin_for_matrix_between_two_points= 0.5; //The larger the distance, the greater the route options but the longer the waiting time
